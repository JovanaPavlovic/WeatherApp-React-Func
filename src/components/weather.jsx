      ...
      <div className='row card-row'>
        <div className='card card-1 col-sm-12 mb-2 mr-0'>
          <div className='card-body bg-info'>
            {hasLoaded && (
              <h5 className='card-text py-2'>{convertDate(today.dt)}</h5>
            )}
            ...
            <div>
              {hasLoaded && <h4 className='py-3'>{today.weather[0].main}</h4>}
            </div>
            ...
            <div>
              <span className='px-5'>
                {hasLoaded && <h5>Min {roundTemp(today.temp.min)}&deg;C</h5>}
                {hasLoaded && <h5>Max {roundTemp(today.temp.max)}&deg;C</h5>}
              </span>
            </div>
          </div>
        </div>
